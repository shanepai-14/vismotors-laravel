<x-app-layout>
    ...
    <section class="card  p-5">
                ...
                @else              
                   ...
                   <div>
                     ...
                     <div class="d-flex justify-content-between">
                       ...
                       <h6>Account Name</h6>
                       <span class="fw-bold text-success ms-1"> {{$transactions->customers->fullname() }} </span>
                     ...
                     <div class="d-flex justify-content-between">
                       ...
                       <div class="d-flex flex-row align-items-center text-primary">
                         <span class="fw-bold text-success ms-1">{{ $transactions->transaction_types->name }}</span>
                       </div>
                     </div>
                     ...
                     <div class="d-flex justify-content-between align-items-center bg-body-tertiary">
                       <h6>Loan Term</h6>
                       <span class="fw-bold text-success ms-1">{{$transactions->loan_tenure_months}} months</span>
                     </div>
                
                        <div class="d-flex justify-content-between align-items-center bg-body-tertiary">
                            <h6>Due date</h6>
                            <span class="fw-bold text-success ms-1">Every <i class="text-danger">{{$transactions->due_date.''. getDaySuffix($transactions->due_date)}}</i> of the month</span>
                          </div>
                      <div class="d-flex justify-content-between align-items-center bg-body-tertiary">
                       <h6>Monthy Due</h6>
                     ...
                     <div class="d-flex mt-1  justify-content-between align-items-center">
                       ...
                       <div class="d-flex align-items-center "><h6 class="fw-bold text-success ms-1 m-0">₱</h6><input class="form-control form-control-sm" name="amount"  style="width: 105px;" type="number" value="{{$transactions->monthly_due}}"></div>
                   </div>
                   @endif
                     <div class="d-flex align-items-center justify-content-between mb-3 mt-2">
                       <h6 class="mb-0">{{$transactions->transaction_types->name !== 'Cash' ? 'Payment Method' : 'Total amount paid'}}</h6>
                       @if($transactions->transaction_types->name !== 'Cash')
                       <div class=" d-flex  align-items-center gap-2" data-gtm-form-interact-id="0">
                           <div class="d-flex flex-row ">
                             <div class="d-flex align-items-center pe-2">
                               <input class="form-check-input" type="radio" name="payment_method" id="payment_method1" value="Cash" aria-label="..." checked="" autocompleted="" data-gtm-form-interact-field-id="1">
                             </div>
                 ...
                 <div class="modal-footer">
                    ...
                    @else
                    <button type="button"  class="btn btn-info btn-block" onclick="printDiv('printJS-form')" >Print</button>
                    @endif
        ...
        <div>
            <div class="col-md-5 col-lg-4 col-xl-4 offset-lg-1 offset-xl-2" id="or_layout" style="display: none">
                <div class="p-3 bg-body-tertiary" id="order">
                    <h1 class="text-center mb-0">Vismotors Corp.</h1>
                 ...
                 @else              
                  ...
                  <hr />
                  <div class="d-flex justify-content-between mt-2">
                    <span>Total Amount paid</span> <span class="text-success" id="total_amount_paid">$85.00</span>
                  </div>
                </div>
        </div>
