									...
									<div class="border border-3 p-4 rounded">
										...
										<div class="row  g-3 mb-2">
											...
											<div class="col-4">
												...
												<input class="form-control" id="address_lot" name="address_lot" type="text"
											...
											<div class="col-4">
												...
												<input class="form-control" id="address_brgy" name="address_brgy" type="text"
											...
											<div class="col-4">
												...
												<input class="form-control" id="address_landmark" name="address_landmark" type="text"
											...
											<div class="col-4">
												...
												<input class="form-control" id="address_prov" name="address_prov" type="text"
											...
											<div class="col-4">
												...
												<select class="form-select" id="citizenship_id" name="citizenship_id">
													<option selected value="">--Select--</option>
											...
											<div class="col-4">
												...
												<select class="form-select" id="civil_status_id" name="civil_status_id">
													<option selected value="">--Select--</option>
									...
									<div class="border border-3 p-4 rounded mb-4">
										...
										<div class="row g-3 mb-2">
											<div class="col-12">
												...
												@endif
												 <div class="form-check">
													<input  type="hidden" name="profile_temp"  id="profile_temp" value="{{isset($user->profile->profile_picture) ? $user->profile->profile_picture : ''}}" >
									...
									<div class=" border border-3 p-4 rounded mb-4">
										<div class="row g-3 mb-2">
											<div class="col-12">
												...
												@endif
												 <div class="form-check">
													<input  type="hidden" name="valid_one_temp"  id="valid_one_temp" value="{{isset($user->profile->valid_one) ? $user->profile->valid_one : ''}}" >
									...
									<div class=" border border-3 p-4 rounded mb-4">
										<div class="row g-3 mb-2">
											<div class="col-12">
												...
												@endif
												 <div class="form-check">
													<input  type="hidden" name="valid_two_temp"  id="valid_two_temp" value="{{isset($user->profile->valid_two) ? $user->profile->valid_two : ''}}" >
  ...
  server: {     
      ...
      revert: {
          ...
          data: (file) => {
              ...
              return JSON.stringify({ fileId: file });
          }
      }
  }
});
...
function initMap() {
	map = L.map('mapContainer').setView([lat !== '' ? lat : 9.299996171243155, lng !== '' ? lng : 123.30301500485619], 13); // Default center coordinates and zoom level

	L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
		attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
	}).addTo(map);

	marker = L.marker([lat !== '' ? lat : 9.299996171243155, lng !== '' ? lng : 123.30301500485619], { // Default marker position
		draggable: true
	}).addTo(map);
